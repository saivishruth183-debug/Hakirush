...
import { 
  Trophy, CheckCircle, ArrowRight, Sparkles, Crown, ArrowLeft, 
...
const ContinuousSportsBackground = () => {
  const row1 = [Trophy, Activity, Target, CircleDot, Crown, Dumbbell];
  const row2 = [Flag, Zap, Trophy, Sparkles, Target, Crown];
  ...
  return (
    <div className="fixed inset-0 overflow-hidden bg-white pointer-events-none z-0">
      ...
      {/* Row 2: Moving Right */}
      <div className="flex absolute top-[50%] opacity-[0.03]">
        <motion.div 
          initial={{ x: "-100%" }}
          animate={{ x: 0 }}
...
export default function SponsorGrid() {
  ...
  return (
    <div className="bg-gray-50 relative overflow-hidden min-h-screen">
      ...
      {/* Back Button - Ensure z-index is high to stay clickable */}
