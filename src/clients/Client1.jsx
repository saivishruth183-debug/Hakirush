        ...
        <div className='max-w-6xl mx-auto px-4 sm:px-6 relative z-10'>
          ...
          >
            ...
            <p className='mt-3 sm:mt-4 text-xs sm:text-base md:text-lg text-gray-700 max-w-4xl mx-auto leading-relaxed font-medium px-2'>
              Transforming workplace culture through innovative sports engagement programs
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className='py-12 sm:py-16 bg-gray-50'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6'>
          <div className='grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6'>
            {[
              { icon: <Users className='w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8' />, value: '500+', label: 'Employees Engaged' },
              { icon: <Calendar className='w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8' />, value: '24', label: 'Tournaments Hosted' },
              { icon: <Trophy className='w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8' />, value: '95%', label: 'Satisfaction Rate' },
              { icon: <Target className='w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8' />, value: '3 Years', label: 'Partnership' }
            ].map((stat, i) => (
              <motion.div
                key={i}
        ...
        <div className='max-w-7xl mx-auto px-6'>
          ...
          >
            ...
            <p className='text-lg text-gray-600 max-w-3xl mx-auto'>
              Tech Solutions Inc. needed to boost employee engagement and break down departmental silos
            </p>
          </motion.div>
              ...
              <div className='bg-linear-to-br from-[#C21807] to-[#A01506] p-8 rounded-3xl text-white shadow-2xl'>
                ...
                <div className='space-y-6'>
                  <div>
                    ...
                    <p className='text-white/90'>Increase in cross-team collaboration</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className='text-white/90'>Boost in overall team morale</p>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          >
            ...
            <div className='relative'>
              <p className='text-lg md:text-xl text-gray-700 leading-relaxed italic mb-8'>
                "HAKIRUSH has completely transformed our workplace culture. The tournaments have become the highlight of every month, and we've seen unprecedented collaboration between teams."
              </p>
              <div className='flex items-center gap-4'>
                ...
                <div>
                  ...
                  <div className='text-gray-600'>CEO, Tech Solutions Inc.</div>
                </div>
              </div>
            </div>
          </motion.div>
