        ...
        <div className='max-w-6xl mx-auto px-4 sm:px-6 relative z-10'>
          ...
          >
            ...
            <p className='mt-3 sm:mt-4 text-xs sm:text-base md:text-lg text-gray-700 max-w-4xl mx-auto leading-relaxed font-medium px-2'>
              Fostering teamwork and reducing stress through regular sports activities
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className='py-12 sm:py-16 bg-gray-50'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6'>
          <div className='grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6'>
            {[
              { icon: <Users className='w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8' />, value: '350+', label: 'Active Players' },
              { icon: <Calendar className='w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8' />, value: '18', label: 'Quarterly Events' },
              { icon: <Trophy className='w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8' />, value: '96%', label: 'Happiness Score' },
              { icon: <Target className='w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8' />, value: '1.5 Years', label: 'Partnership' }
            ].map((stat, i) => (
              <motion.div
                key={i}
        ...
        <div className='max-w-7xl mx-auto px-6'>
          ...
          >
            <h2 className='text-3xl md:text-4xl font-black text-gray-900 mb-4'>
              The <span className='bg-linear-to-r from-[#C21807] to-[#A01506] bg-clip-text text-transparent'>Transformation</span>
            </h2>
            <p className='text-lg text-gray-600 max-w-3xl mx-auto'>
              Creating work-life balance in a high-pressure financial services environment
            </p>
          </motion.div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
            ...
            >
              <div className='bg-linear-to-br from-gray-50 to-gray-100 p-8 rounded-3xl border border-gray-200'>
                ...
                <div className='space-y-4'>
                  {[
                    'Stress-relief focused activities',
            ...
            >
              <div className='bg-linear-to-br from-[#C21807] to-[#A01506] p-8 rounded-3xl text-white shadow-2xl'>
                <h3 className='text-2xl font-bold mb-6'>Measurable Success</h3>
                <div className='space-y-6'>
                  <div>
                    <div className='text-4xl font-black mb-2'>60%</div>
                    <p className='text-white/90'>Decrease in stress levels</p>
                  </div>
                  <div>
                    <div className='text-4xl font-black mb-2'>90%</div>
                    <p className='text-white/90'>Employee retention rate</p>
                  </div>
                  <div>
                    <div className='text-4xl font-black mb-2'>75%</div>
                    <p className='text-white/90'>Improvement in team dynamics</p>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          >
            ...
            <div className='relative'>
              <p className='text-lg md:text-xl text-gray-700 leading-relaxed italic mb-8'>
                "In our demanding industry, HAKIRUSH's programs provide the perfect outlet for our teams. The impact on morale and productivity has been remarkable."
              </p>
              <div className='flex items-center gap-4'>
                ...
                <div>
                  <div className='font-bold text-gray-900 text-lg'>Vikram Kapoor</div>
                  <div className='text-gray-600'>Managing Director, Finance Corp International</div>
                </div>
              </div>
            </div>
          </motion.div>
