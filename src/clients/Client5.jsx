      ...
      <section className='py-12 sm:py-16 bg-gray-50'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6'>
          <div className='grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6'>
            {[
              { icon: <Users className='w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8' />, value: '450+', label: 'Team Members' },
              { icon: <Calendar className='w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8' />, value: '20', label: 'Monthly Activities' },
              { icon: <Trophy className='w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8' />, value: '97%', label: 'Approval Rating' },
              { icon: <Target className='w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8' />, value: '1 Year', label: 'Partnership' }
            ].map((stat, i) => (
              <motion.div
                key={i}
        ...
        <div className='max-w-7xl mx-auto px-6'>
          ...
          >
            <h2 className='text-3xl md:text-4xl font-black text-gray-900 mb-4'>
              The <span className='bg-linear-to-r from-[#C21807] to-[#A01506] bg-clip-text text-transparent'>Initiative</span>
            </h2>
