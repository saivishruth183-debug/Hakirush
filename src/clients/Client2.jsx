          ...
          >
            ...
            <div className='flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-3 md:gap-4 mb-4 sm:mb-6'>
              ...
              <h1 className='text-xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-gray-900 tracking-tight text-center sm:text-left'>
                Creative Minds <span className='bg-linear-to-r from-[#C21807] via-[#A01506] to-[#C21807] bg-clip-text text-transparent drop-shadow-sm'>LLP</span>
              </h1>
            </div>
            <p className='mt-3 sm:mt-4 text-xs sm:text-base md:text-lg text-gray-700 max-w-4xl mx-auto leading-relaxed font-medium px-2'>
              Empowering teams through collaborative and creative event experiences
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className='py-12 sm:py-16 bg-gray-50'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6'>
          <div className='grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6'>
            {[
              { icon: <Users className='w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8' />, value: '300+', label: 'Employees Engaged' },
              { icon: <Calendar className='w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8' />, value: '12', label: 'Events Hosted' },
              { icon: <Trophy className='w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8' />, value: '98%', label: 'Satisfaction Rate' },
              { icon: <Target className='w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8' />, value: '2 Years', label: 'Partnership' }
            ].map((stat, i) => (
              <motion.div
                key={i}
        ...
        <div className='max-w-7xl mx-auto px-6'>
          ...
          >
            <h2 className='text-3xl md:text-4xl font-black text-gray-900 mb-4'>
              The <span className='bg-linear-to-r from-[#C21807] to-[#A01506] bg-clip-text text-transparent'>Challenge</span>
            </h2>
            <p className='text-lg text-gray-600 max-w-3xl mx-auto'>
              Creative Minds LLP wanted to foster creativity and collaboration among employees through engaging events
            </p>
          </motion.div>
              ...
              <div className='bg-linear-to-br from-[#C21807] to-[#A01506] p-8 rounded-3xl text-white shadow-2xl'>
                ...
                <div className='space-y-6'>
                  <div>
                    ...
                    <p className='text-white/90'>Increase in creative output</p>
                  </div>
                  <div>
                    <div className='text-4xl font-black mb-2'>95%</div>
                    <p className='text-white/90'>Employee satisfaction improvement</p>
                  </div>
                  <div>
                    <div className='text-4xl font-black mb-2'>35%</div>
                    <p className='text-white/90'>Boost in team collaboration</p>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          >
            ...
            <div className='relative'>
              <p className='text-lg md:text-xl text-gray-700 leading-relaxed italic mb-8'>
                "HAKIRUSH has inspired our teams to think outside the box. The events are always fresh, fun, and foster a real sense of community."
              </p>
              <div className='flex items-center gap-4'>
                ...
                <div>
                  <div className='font-bold text-gray-900 text-lg'>Anjali Kapoor</div>
                  <div className='text-gray-600'>HR Head, Creative Minds LLP</div>
                </div>
              </div>
            </div>
          </motion.div>
