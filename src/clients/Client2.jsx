        ...
        <div className='max-w-6xl mx-auto px-4 sm:px-6 relative z-10'>
          ...
          >
            ...
            <p className='mt-3 sm:mt-4 text-xs sm:text-base md:text-lg text-gray-700 max-w-4xl mx-auto leading-relaxed font-medium px-2'>
              Building stronger teams through competitive sports and recreational activities
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className='py-12 sm:py-16 bg-gray-50'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6'>
          <div className='grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6'>
            {[
              { icon: <Users className='w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8' />, value: '800+', label: 'Participants' },
              { icon: <Calendar className='w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8' />, value: '36', label: 'Events Conducted' },
              { icon: <Trophy className='w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8' />, value: '98%', label: 'Engagement Rate' },
        ...
        <div className='max-w-7xl mx-auto px-6'>
          ...
          >
            <h2 className='text-3xl md:text-4xl font-black text-gray-900 mb-4'>
              The <span className='bg-gradient-to-r from-[#C21807] to-[#A01506] bg-clip-text text-transparent'>Journey</span>
            </h2>
            <p className='text-lg text-gray-600 max-w-3xl mx-auto'>
              Revitalizing employee wellness and creating a vibrant sports culture across multiple locations
            </p>
          </motion.div>
            ...
            >
              <div className='bg-gradient-to-br from-gray-50 to-gray-100 p-8 rounded-3xl border border-gray-200'>
                ...
                <div className='space-y-4'>
                  {[
                    'Monthly inter-plant tournaments',
              ...
              <div className='bg-gradient-to-br from-[#C21807] to-[#A01506] p-8 rounded-3xl text-white shadow-2xl'>
                ...
                <div className='space-y-6'>
                  <div>
                    ...
                    <p className='text-white/90'>Improvement in employee wellness</p>
                  </div>
                  <div>
                    <div className='text-4xl font-black mb-2'>88%</div>
                    <p className='text-white/90'>Participation rate achieved</p>
                  </div>
                  <div>
                    <div className='text-4xl font-black mb-2'>50%</div>
                    <p className='text-white/90'>Reduction in attrition</p>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          >
            ...
            <div className='relative'>
              <p className='text-lg md:text-xl text-gray-700 leading-relaxed italic mb-8'>
                "The sports programs by HAKIRUSH have been instrumental in building a healthier, more connected workforce. Our employees are more energized and collaborative than ever."
              </p>
              <div className='flex items-center gap-4'>
                ...
                <div>
                  <div className='font-bold text-gray-900 text-lg'>Anita Mehta</div>
                  <div className='text-gray-600'>Head of HR, Global Manufacturing Ltd.</div>
                </div>
              </div>
            </div>
          </motion.div>
