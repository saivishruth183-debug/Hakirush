        ...
        <div className='max-w-6xl mx-auto px-4 sm:px-6 relative z-10'>
          ...
          >
            ...
            <div className='inline-flex items-center gap-1.5 sm:gap-2 px-4 py-2 sm:px-5 sm:py-2.5 rounded-full bg-linear-to-r from-[#C21807]/10 to-[#A01506]/10 border border-[#C21807]/30 shadow-lg backdrop-blur-sm mb-6 sm:mb-8'>
              ...
              <span className='text-xs sm:text-sm font-bold text-[#C21807]'>Title Sponsor</span>
            </div>
            ...
            <p className='mt-3 sm:mt-4 text-xs sm:text-base md:text-lg text-gray-700 max-w-4xl mx-auto leading-relaxed font-medium px-2'>
              Premier sports equipment brand powering excellence in corporate sports tournaments
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className='py-12 sm:py-16 bg-gray-50'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6'>
          <div className='grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6'>
            {[
              { icon: <Eye className='w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8' />, value: '50K+', label: 'Brand Impressions' },
              { icon: <Users className='w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8' />, value: '10K+', label: 'Audience Reach' },
              { icon: <TrendingUp className='w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8' />, value: '500+', label: 'Events Visibility' },
              { icon: <Star className='w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8' />, value: '95%', label: 'Brand Recognition' }
            ].map((stat, i) => (
              <motion.div
                key={i}
              ...
              >
                <div className='inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-red-100 text-red-700 rounded-xl sm:rounded-2xl mb-3 sm:mb-4'>
                  {stat.icon}
                </div>
        ...
        <div className='max-w-7xl mx-auto px-6'>
          ...
          >
            <h2 className='text-3xl md:text-4xl font-black text-gray-900 mb-4'>
              Sponsorship <span className='bg-linear-to-r from-[#C21807] to-[#A01506] bg-clip-text text-transparent'>Benefits</span>
            </h2>
            <p className='text-lg text-gray-600 max-w-3xl mx-auto'>
              Comprehensive brand visibility and engagement across all HAKIRUSH events
            </p>
          </motion.div>
            ...
            >
              <div className='bg-linear-to-br from-[#C21807] to-[#A01506] p-8 rounded-3xl text-white shadow-2xl'>
                ...
                <div className='space-y-6'>
                  <div>
                    <div className='text-4xl font-black mb-2'>₹25L+</div>
                    <p className='text-white/90'>Annual marketing value</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className='text-white/90'>Corporate partners reached</p>
                  </div>
                </div>
              </div>
            </motion.div>
        ...
        <div className='max-w-4xl mx-auto px-6'>
          ...
          >
            ...
            <div className='relative'>
              <h3 className='text-2xl md:text-3xl font-bold text-gray-900 mb-6'>Partnership Overview</h3>
              <p className='text-lg text-gray-700 leading-relaxed mb-6'>
                SportGear Pro has been our esteemed title sponsor since 2022, providing top-quality sports equipment and gear for all our tournaments. Their commitment to excellence aligns perfectly with HAKIRUSH's mission to deliver professional-grade sports experiences.
              </p>
              <p className='text-lg text-gray-700 leading-relaxed'>
                Through this partnership, thousands of corporate employees have access to premium sports equipment, enhancing their tournament experience and promoting active lifestyles in the workplace.
              </p>
              <div className='mt-8 pt-6 border-t border-gray-200'>
                <div className='flex items-center gap-4'>
                  ...
                  <div>
                    <div className='font-bold text-gray-900 text-lg'>SportGear Pro</div>
                    <div className='text-gray-600'>Title Sponsor - Since 2022</div>
                  </div>
                </div>
              </div>
            </div>
