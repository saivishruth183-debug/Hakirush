      ...
      <section className='relative bg-gradient-to-br from-[#C21807] via-[#A01506] to-[#8B1205] text-white py-20 overflow-hidden'>
        ...
        <div className='max-w-7xl mx-auto px-6 relative z-10'>
          ...
          >
            ...
            <h1 className='text-4xl md:text-6xl font-black mb-6 leading-tight'>SportGear Pro</h1>
      ...
      <section className='py-16 bg-gray-50'>
        <div className='max-w-7xl mx-auto px-6'>
          <div className='grid grid-cols-1 md:grid-cols-4 gap-6'>
            {[
              { icon: <Eye className='w-8 h-8' />, value: '50K+', label: 'Brand Impressions' },
              { icon: <Users className='w-8 h-8' />, value: '10K+', label: 'Audience Reach' },
              { icon: <TrendingUp className='w-8 h-8' />, value: '500+', label: 'Events Visibility' },
              { icon: <Star className='w-8 h-8' />, value: '95%', label: 'Brand Recognition' }
            ].map((stat, i) => (
              <motion.div
                key={i}
