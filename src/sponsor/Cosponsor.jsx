...
import { Users, CheckCircle, ArrowRight, Sparkles, Star } from "lucide-react";
    ...
    <div className="relative overflow-hidden bg-white">
      ...
      <section className="relative py-20 overflow-hidden bg-white">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          ...
          >
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-linear-to-r from-orange-50 to-red-50 border border-orange-100 mb-8">
              <Star className="w-4 h-4 text-orange-600 fill-orange-600" />
              <span className="text-sm font-semibold text-orange-600">Strategic Partnership</span>
            </div>

            {/* Icon and Title in Row */}
            <div className="flex items-center justify-center gap-6 mb-6">
              <div className="inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-linear-to-br from-orange-500 to-red-500 shadow-2xl shrink-0">
          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            >
              ...
              <div className="relative p-10">
                ...
                <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-linear-to-r from-orange-500 to-red-500 mb-8 shadow-lg group-hover:shadow-orange-500/50 transition-shadow duration-300">
                  <Sparkles className="w-4 h-4 text-white animate-pulse" />
                  <span className="text-sm font-bold text-white tracking-wide">PACKAGE INCLUDES</span>
                </div>

                <h3 className="text-4xl font-extrabold text-gray-900 mb-8 group-hover:text-transparent group-hover:bg-linear-to-r group-hover:from-orange-600 group-hover:to-red-500 group-hover:bg-clip-text transition-all duration-300">
                  What You Get
                </h3>
                  ...
                  {s.details.whatYouGet.map((item, idx) => (
                    ...
                    >
                      <div className="shrink-0 mt-0.5">
                        <CheckCircle className="w-5 h-5 text-orange-600 group-hover/item:scale-110 transition-transform" />
                      </div>
            ...
            >
              ...
              <div className="relative p-10">
                {/* Icon Badge with Glow */}
                <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-linear-to-r from-orange-500 to-red-500 mb-8 shadow-lg group-hover:shadow-red-500/50 transition-shadow duration-300">
          ...
          <div className="text-center mt-16">
            <Link to="/contact">
              <motion.button
                ...
                className="inline-flex items-center justify-center gap-3 px-12 py-5 bg-linear-to-r from-orange-500 to-red-500 text-white font-bold text-lg rounded-xl shadow-xl hover:shadow-2xl hover:shadow-orange-500/50 transition-all duration-300 cursor-pointer relative overflow-hidden group"
              >
