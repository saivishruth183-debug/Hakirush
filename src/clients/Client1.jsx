      ...
      <section className='relative bg-gradient-to-br from-[#C21807] via-[#A01506] to-[#8B1205] text-white py-20 overflow-hidden'>
        ...
        <div className='max-w-7xl mx-auto px-6 relative z-10'>
          ...
          >
            ...
            <h1 className='text-4xl md:text-6xl font-black mb-6 leading-tight'>Tech Solutions Inc.</h1>
      ...
      <section className='py-16 bg-gray-50'>
        <div className='max-w-7xl mx-auto px-6'>
          <div className='grid grid-cols-1 md:grid-cols-4 gap-6'>
            {[
              { icon: <Users className='w-8 h-8' />, value: '500+', label: 'Employees Engaged' },
              { icon: <Calendar className='w-8 h-8' />, value: '24', label: 'Tournaments Hosted' },
              { icon: <Trophy className='w-8 h-8' />, value: '95%', label: 'Satisfaction Rate' },
              { icon: <Target className='w-8 h-8' />, value: '3 Years', label: 'Partnership' }
            ].map((stat, i) => (
              <motion.div
                key={i}
